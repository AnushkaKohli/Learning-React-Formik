                ...
                (formik) => {
                    return (
                        <Form className="space-y-4 md:space-y-6">
                                ...
                                <FieldArray name="friends">
                                    {
                                        (fieldArrayProps) => {
                                            ...
                                            // To check when form validation runs
                            ...
                            } className="rounded-lg border border-black px-4 py-2 mr-4">Validate Comments</button>
                            ...
                            <button type="button" onClick={() => {
                                ...
                                formik.validateForm()
                            }} className="rounded-lg border border-black px-4 py-2">Validate All</button>
